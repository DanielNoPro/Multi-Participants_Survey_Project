...
$(function () {
    ...
    var $authControl = $('#authenticate-control')
    ...
    // Authentication: none
    $authControl.find("[data-authenticate='none']").click(function (event) {
        event.preventDefault()
        window.auth = null
        $selectedAuthentication.text('none')
        $authControl.find("[data-authenticate]").closest('li').removeClass('active')
        $authControl.find("[data-authenticate='none']").closest('li').addClass('active')
    })
    ...
    $('form.authentication-token-form').submit(function (event) {
        ...
        $authControl.find("[data-authenticate]").closest('li').removeClass('active')
        $authControl.find("[data-authenticate='token']").closest('li').addClass('active')
    ...
    $('form.authentication-basic-form').submit(function (event) {
        ...
        $authControl.find("[data-authenticate]").closest('li').removeClass('active')
        $authControl.find("[data-authenticate='basic']").closest('li').addClass('active')
    ...
    $('form.authentication-session-form').submit(function (event) {
        ...
        $authControl.find("[data-authenticate]").closest('li').removeClass('active')
        $authControl.find("[data-authenticate='session']").closest('li').addClass('active')
